...
class Striker(HackingTool):
    ...
    def run(self):
        ...
        subprocess.run(["sudo", "python3", "striker.py", site], cwd="Striker")
...
class PortScannerRanger(HackingTool):
    ...
    def run(self):
        ...
        subprocess.run(["sudo", "python", "rang3r.py", "--ip", ip], cwd="rang3r")
...
class Breacher(HackingTool):
    ...
    def run(self):
        ...
        subprocess.run(["python3", "breacher.py", "-u", domain], cwd="Breacher")
